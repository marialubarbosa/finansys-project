...
export class EntryFormComponent implements OnInit, AfterContentChecked {
  ...
  //   montNames: [  'Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro' ],
  ...
  private actionsForError(error){
    ...
    if(error.status === 422){
      ...
      this.serverErrorMessages = ["Falha na cominucação com o servidor, por favor, tente mais tarde."]
    }
  }
